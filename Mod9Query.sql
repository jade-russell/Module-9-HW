...
COPY departments FROM 'D:/Bootcamp stuff/Module 9/data/departments.csv' DELIMITER ',' CSV HEADER;
COPY titles FROM 'D:/Bootcamp stuff/Module 9/data/titles.csv' DELIMITER ',' CSV HEADER;
COPY employees FROM 'D:/Bootcamp stuff/Module 9/data/employees.csv' DELIMITER ',' CSV HEADER;
COPY dept_emp FROM 'D:/Bootcamp stuff/Module 9/data/dept_emp.csv' DELIMITER ',' CSV HEADER;
COPY dept_manager FROM 'D:/Bootcamp stuff/Module 9/data/dept_manager.csv' DELIMITER ',' CSV HEADER;
COPY salaries FROM 'D:/Bootcamp stuff/Module 9/data/salaries.csv' DELIMITER ',' CSV HEADER;